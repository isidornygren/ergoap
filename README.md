...
Utility GOAP is an implementation of the GOAP (Goal Oriented Action Planning) system outlined in [this talk](https://www.youtube.com/watch?v=PaOLBOuyswI) with focus on ergonomics and ease-of-use.
